...
- Språkregel för företagsinformation: svenska räcker för internt underlag eftersom en modell översätter, MEN fackord måste vara beslutade i ordlistan annars gissar den fel. Engelska lagras bara där texten går rakt ut till kund (positioneringen) eller där engelskan är ett beslut (termerna). Maskinnamn, komponentnamn och kategorinamn översätts aldrig.
