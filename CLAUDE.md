...
- machine_questions + machines.knowledge_note: Kunskapsbanken på /maskiner/[id]. Frågorna är strukturerade (fråga + valfri notering, ordnade), fritexten är allt annat ni vet om produkten. Fritexten är avsiktligt formlös: den ska gå att dumpa i, inte fyllas i. Samma mönster som projects.conditions_note under förutsättningarna.
