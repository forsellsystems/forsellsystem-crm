...
- Projektets utredning före affär, två kort på /projekt/[id]: "Aktuella produkter" (project_machines: vilka av våra maskiner som är aktuella, med antal och valfri notering om varför; antal 1 visas inte, det säger ingenting) och "Förutsättningar" (project_specs: kundens mått). Tom lista betyder att utredningen inte kommit dit än, inte att svaret är noll.
