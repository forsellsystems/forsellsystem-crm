...
- Projektets utredning före affär, två kort på /projekt/[id]: "Aktuella produkter" (project_machines: vilka av våra maskiner som är aktuella, med valfri notering om varför) och "Förutsättningar" (project_specs: kundens mått). Tom lista betyder att utredningen inte kommit dit än, inte att svaret är noll.
